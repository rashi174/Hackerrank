...
Complete the counterGame function in the editor below. It should return the winner's name, \
either Richard or Louise.
...
Explanation 0
 ...
 6 is not a power of  so Louise reduces it by the largest power of  less than :.
 4 is a power of  so Richard divides by 2 to get  1 and wins the game.
'''
